  ...
  export const Navbar = () => {
    ...
    return (
      <>
        {/* Desktop Navigation */}
        <NavigationMenu
          className={`hidden lg:flex fixed top-4 sm:top-6 left-1/2 transform -translate-x-1/2 z-50 px-4 sm:px-6 py-2 rounded-xl shadow-lg transition-all duration-500 ease-in-out
          ${isAtTop
            ? "opacity-100 translate-y-0 backdrop-blur-md bg-white/80"
            : "opacity-100 -translate-y-4 backdrop-blur-sm bg-white/60"
          }`}
        >
          <div className="whitespace-nowrap text-lg sm:text-xl font-semibold mr-8 lg:mr-20 ml-4 lg:ml-10 text-[#304674]">
            CSI KKWIEER
          </div>
          ...
          <img
            src="/images/csi.png"
            className="h-10 w-10 lg:h-[50px] lg:w-[50px] ml-8 lg:ml-20 mr-4 lg:mr-10"
            alt="CSI Logo"
          />
        </NavigationMenu>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <img src="/images/csi.png" className="h-8 w-8 sm:h-10 sm:w-10" alt="CSI Logo" />
                <span className="text-lg sm:text-xl font-semibold text-[#304674]">CSI</span>
              </div>
